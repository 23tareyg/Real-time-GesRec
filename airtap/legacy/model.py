...
from airtap.legacy.models import c3d, squeezenet, mobilenet, shufflenet, mobilenetv2, shufflenetv2, resnext, resnet, resnetl
import pdb
...
def generate_model(opt):
    ...
    if opt.model == 'c3d':
        from airtap.legacy.models.c3d import get_fine_tuning_parameters
        model = c3d.get_model(
            num_classes=opt.n_classes,
            sample_size=opt.sample_size,
            sample_duration=opt.sample_duration)
    elif opt.model == 'squeezenet':
        from airtap.legacy.models.squeezenet import get_fine_tuning_parameters
        ...
        from airtap.legacy.models.shufflenet import get_fine_tuning_parameters
        model = shufflenet.get_model(
            groups=opt.groups,
            width_mult=opt.width_mult,
            num_classes=opt.n_classes)
    elif opt.model == 'shufflenetv2':
        from airtap.legacy.models.shufflenetv2 import get_fine_tuning_parameters
        model = shufflenetv2.get_model(
            num_classes=opt.n_classes,
            sample_size=opt.sample_size,
            width_mult=opt.width_mult)
    elif opt.model == 'mobilenet':
        from airtap.legacy.models.mobilenet import get_fine_tuning_parameters
        model = mobilenet.get_model(
            num_classes=opt.n_classes,
            sample_size=opt.sample_size,
            width_mult=opt.width_mult)
    elif opt.model == 'mobilenetv2':
        from airtap.legacy.models.mobilenetv2 import get_fine_tuning_parameters
        ...
        from airtap.legacy.models.resnext import get_fine_tuning_parameters
        ...
        from airtap.legacy.models.resnetl import get_fine_tuning_parameters
        ...
        from airtap.legacy.models.resnet import get_fine_tuning_parameters
        if opt.model_depth == 10:
