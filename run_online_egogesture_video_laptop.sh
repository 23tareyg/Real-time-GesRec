...
# On macOS, this can also be an iPhone Continuity Camera / virtual webcam index
# or an IP camera URL exposed by your phone.
VIDEO="${1:-0}"
...
#
# For Apple Silicon: this script now defaults to CPU because PyTorch MPS is
# missing some 3D ops used by the models. To try MPS anyway:
#   REALTIME_GESREC_USE_MPS=1 ./run_online_egogesture_video.sh 0
#
